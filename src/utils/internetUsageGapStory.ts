export const storyStepsEn = [
  {
    ...
    body: [
      ...
      "The map is tinted by sub-region. What it shows, step by step, is how internet use and price separate across the continent, and where the simple explanations stop working."
    ],
    pills: [
  ...
  },
  {
    ...
    body: [
      "The map dims to hold context. The price story sits in the numbers. Zimbabwe pays $43.75 for 1GB of mobile data. Zambia pays $8.01.",
...
export const storyStepsFr = [
  {
    ...
    body: [
      ...
      "La carte est teintee par sous-region. Ce qu'elle montre, etape par etape, c'est comment l'usage et le prix se separent a travers le continent, et ou les explications simples cessent de fonctionner."
    ],
    pills: [
  ...
  },
  {
    ...
    body: [
      "La carte s'attenue pour garder le contexte. L'histoire du prix est dans les chiffres. Le Zimbabwe paie 43.75 USD pour 1GB de donnees mobiles. La Zambie paie 8.01 USD.",
